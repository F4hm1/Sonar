...
public class Resources {
    ...
    public static final String API_GET_INTERESTS = "http://www.paws.it/API/getinteressi.php";
    public static final String API_SET_INTERESTS = "http://www.paws.it/API/aggiungiinteressi.php";
